// Code generated by "enumer -gqlgen -json -sql -text -yaml -values -type LogEnum -output log_enum_generated.go"; DO NOT EDIT.
...
func (LogEnum) Values() []string {
	return LogEnumStrings()
}
